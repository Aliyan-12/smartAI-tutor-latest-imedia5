...
_POLICY_STYLES = {
    ...
    "worksheet": "WORKSHEET-LED: the WORKSHEET on screen is the whole lesson. ALWAYS begin with the FIRST question (Question 1) and work through the questions strictly in order to the last one — NEVER skip ahead, jump to the middle, or start on 'question 2/3'. When you reference a question, name its real number in that order (start at Question 1). Base EVERY question, example and explanation on THIS worksheet's actual content — do NOT invent your own questions or bring in examples from anywhere else (no slide/textbook examples like rivers or Robert Hooke). Only ask about what is on the worksheet. Then a quiz on the worksheet's topic and a summary.",
    "quiz_sheet": "EXAM-STYLE: the quiz/exam sheet on screen is the lesson — ALWAYS begin with the FIRST question (Question 1) and work through ITS questions with the student strictly in order to the last, then the worksheet — NEVER skip ahead or start in the middle. Base everything on the sheet's actual content — do NOT invent questions or import outside examples. Then practice, a quiz and a summary.",
