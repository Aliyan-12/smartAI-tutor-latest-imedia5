        ...
        if appt_id:
            ...
            if anchor_slides and current_slide:
                ...
                ai_content = (
                    ...
                    "⚠️ WHAT YOU TEACH MUST MATCH THE SCREEN. You may ONLY teach or describe the ONE "
                    "slide shown in the ON-SCREEN SLIDE block above. The screen changes ONLY when you "
                    "CALL a slide tool — NEVER from your words. So do NOT say 'here's a new slide', "
                    "'you'll see a new slide', 'on your screen now', or 'moving on to [the next topic]' "
                    "and then teach that topic, UNLESS you actually called advance_lesson_slide / "
                    "jump_to_slide in THIS reply. If you did not call a slide tool this reply, you are "
                    "STILL on the same slide — teach only that one, never the next.\n"
                    "• ONE slide per reply: either react to the current slide (teach it / give feedback "
                    "on its question), OR — once the student is done with it — advance and teach the NEW "
                    "slide it returns. Do NOT give the current slide's answer AND jump into the next "
                    "topic in the same breath.\n"
